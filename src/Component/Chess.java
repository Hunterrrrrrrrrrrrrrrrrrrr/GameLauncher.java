...
import java.awt.*;
public class Chess extends Grid{
    protected String name;

    protected Chess(ChessboardPoint chessboardPoint, Point location, ChessColor chessColor,  int size) {
        // int size 前有 ClickController clickController;
        super(chessboardPoint, location, chessColor, size);
        //size 前有 ClickController clickController;
    }
